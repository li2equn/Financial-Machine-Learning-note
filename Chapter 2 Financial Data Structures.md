...
1. We perform a spectral decomposition ![](https://latex.codecogs.com/gif.latex?VW%3DW%5CLambda), where the columns in W are reordered so that the elements of ![](https://latex.codecogs.com/gif.latex?%5CLambda)'s diagonal are sorted in descending order
